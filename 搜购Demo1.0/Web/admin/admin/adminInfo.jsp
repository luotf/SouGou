...
<div class="main comwid"style="margin-top: 10px;">
    <div class="content left" style="border: none;">
        ...
        <div class="message">
            ...
            <p>
                <span>昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称:</span>
                <input type="text" value="${sessionScope.admin.adminNickName}" class="input" placeholder="管理员" disabled/><br>
            </p>
            <p>
                <span>管理员编号:</span>
                <input type="text" value="${sessionScope.admin.adminId}" placeholder="001" class="input" disabled/>
            </p>
            <p>
                <span>电&nbsp;话&nbsp;号&nbsp;码:</span>
                <input type="text" value="${sessionScope.admin.adminPhone}"  maxlength="20" size="20" class="input" placeholder="李四" disabled/>
            </p>
            <p>
                <span>注&nbsp;册&nbsp;时&nbsp;间:</span>
                <input type="text" value="${sessionScope.admin.adminAddTime}"  maxlength="20" size="20" class="input" placeholder="李四" disabled/>
            </p>
