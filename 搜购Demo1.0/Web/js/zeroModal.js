...
(function(obj) {
    ...
    var defaultOpt = {
        ...
        width: '220px', //宽度（px、pt、%）
        height: '220px', //高度（px、pt、%）
    ...
    function _buildModal(opt) {
        ...
        var _top = $(window).scrollTop() + Math.ceil(($(window).height() - _height) /6);
    ...
    function _resize(opt, width, height) {
        ...
        if (typeof _height === 'string') _height = parseInt(_height);
        var _left = (_wwidth - _width) / 2;
        var _top = $(window).scrollTop() + Math.ceil(($(window).height() - _height) / 5);
    ...
    function _resizePostion(opt) {
        ...
        var _left = (_wwidth - _width) / 2;
        var _top = $(window).scrollTop() + Math.ceil(($(window).height() - _height) / 1);
